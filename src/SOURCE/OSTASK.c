...
*                       unsigned int, 'stk_size' contains the number of 16-bit entries available.  Finally, if
*                       OS_STK is set to unsigned long, 'stk_size' contains the number of 32-bit entries
